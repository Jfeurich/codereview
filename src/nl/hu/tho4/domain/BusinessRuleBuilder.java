...
public class BusinessRuleBuilder {
	...
	public BusinessRule interEntityCompareRule(String ruleNaam,String error,Operator o, String errorType, Attribute a1, Attribute a2){
		return rule;
	}
	public BusinessRule entityOtherRule(String ruleNaam, String error, Operator o, String errorType, Attribute a, String s){
		return rule;
	}
}
