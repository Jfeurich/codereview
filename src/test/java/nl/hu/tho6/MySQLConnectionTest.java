...
public class MySQLConnectionTest {
     ...
     */
    @Test
    public void testMySQLConnection_1() throws Exception {

        MySQLConnection result = new MySQLConnection();

        // add additional test code here
        assertNotNull(result); assertEquals(null, result.connect());
    }
     ...
     */
    @Test
    public void testMySQLConnection_2() throws Exception {
     ...
     */
    @Test
    public void testMySQLConnection_3() throws Exception {
     ...
     */
    @Test
    public void testMySQLConnection_4() throws Exception {
     ...
     */
    @Test
    public void testCloseConnection_1() throws Exception {
     ...
     */
    @Test
    public void testCloseConnection_2() throws Exception {
        MySQLConnection fixture = new MySQLConnection();
        //fixture.databaseURL = "";
        Connection con = new OracleOCIConnection("", new Properties(), new Object());
