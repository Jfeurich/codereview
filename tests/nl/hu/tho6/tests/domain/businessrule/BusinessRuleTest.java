...
public class BusinessRuleTest {
    ...
    public void setUp() {
        ...
        testBusinessRule.setErrorType("Type"); testBusinessRule.setCode("Code"); testOperator = new Operator("", "");
        testBusinessRule.setOperator(testOperator); testValue = new Value("", "", "");
    ...
    public void testSetValue1() {
        testValue2 = new Value("a", "a", "a"); testBusinessRule.setValue1(testValue2);
    ...
    public void testSetValue2() {
        testValue2 = new Value("a", "a", "a"); testBusinessRule.setValue2(testValue2);
